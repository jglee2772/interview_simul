# Generated by Django 4.2.7 on 2025-11-18 02:03
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="면접관 이름 (예: 김OO 팀장)", max_length=100
                    ),
                ),
                (
                    "role",
                    models.CharField(
                        help_text="면접관 직무 (예: 시니어 백엔드 개발자)",
                        max_length=100,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "job_topic",
                    models.CharField(
                        help_text="면접 주제 (예: React, Django)", max_length=100
                    ),
                ),
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("started", "시작됨"), ("completed", "완료됨")],
                        default="started",
                        max_length=20,
                    ),
                ),
